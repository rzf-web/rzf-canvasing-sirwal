...
class UnitPage extends GetView<UnitController> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: controller.onUpdateSatuan,
          child: const Icon(Icons.add),
        ),
        body: Obx(
          () => Stack(
            children: [
              if (controller.units().isEmpty && !controller.isLoading.value)
                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          ...controller.units().map((e) => listTile(e)),
  ...
  Widget listTile(String e) {
    return AppListTile(
      ...
      onLongPress: () => controller.onUpdateSatuan(satuan: e),
      trailing: SizedBox(
        height: 30,
        width: 30,
        child: AppSvgIconBtn(
      ...
      isLast: controller.units().last == e,
    );
  }
}
