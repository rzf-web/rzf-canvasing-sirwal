...
class ProductRackPage extends GetView<ProductRackController> {
  const ProductRackPage({super.key});
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: controller.onUpdateRack,
          child: const Icon(Icons.add),
        ),
        body: Obx(
          () => Stack(
            children: [
              if (controller.racks().isEmpty && !controller.isLoading.value)
                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          ...controller.racks().map((e) => listTile(e)),
  ...
  Widget listTile(String e) {
    return AppListTile(
      ...
      onLongPress: () => controller.onUpdateRack(rack: e),
      trailing: SizedBox(
        height: 30,
        width: 30,
        child: AppSvgIconBtn(
      ...
      isLast: controller.racks().last == e,
    );
  }
}
