...
class ProductTypePage extends GetView<ProductTypeController> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: controller.onUpdateType,
          child: const Icon(Icons.add),
        ),
        body: Obx(
          () => Stack(
            children: [
              if (controller.types().isEmpty && !controller.isLoading.value)
                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          ...controller.types().map((e) => listTile(e)),
  ...
  Widget listTile(String e) {
    return AppListTile(
      ...
      onLongPress: () => controller.onUpdateType(type: e),
      trailing: SizedBox(
        height: 30,
        width: 30,
        child: AppSvgIconBtn(
      ...
      isLast: controller.types().last == e,
    );
  }
}
